...
public class GeneralExceptionHandlerTest {
    ...
    public void testHandleInvalidDataException() {
        ...
        ResponseEntity<NotificationErrorResponse> response = exceptionHandler.handleInvalidDataException(ex);
    ...
    public void testHandleBusinessException() {
        ...
        ResponseEntity<NotificationErrorResponse> response = exceptionHandler.handleBusinessException(ex);
    ...
    public void testInternalServerErrorException() {
        ...
        ResponseEntity<NotificationErrorResponse> response = exceptionHandler.InternalServerErrorException(ex);
